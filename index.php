    ...
    <div class="row">
        ...
        <?php if ($lateProducts->num_rows > 0) { ?>
            <?php while ($data = $lateProducts->fetch_object()) { ?>
                <div class="col-md-2">
                    <div class="card py-3">
                        <img src="./images/products/<?= $data->img ?>" alt="" class="card-img-top" style="height: 150px; object-fit: cover;">
                        <div class=" px-2">
                            <div class="fs-5">
                                <a href="./singleProduct.php?id=<?= $data->id ?>"><?= $data->name ?></a>
                            </div>
                            <div>
                                BDT <span class="text-muted text-decoration-line-through"><?= $data->rprice ?></span>/<span><?= $data->dprice ?></span>
                            </div>
